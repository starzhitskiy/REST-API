const requestUrl = 'http://api.tvmaze.com/search/shows?q=cars';
...
const createTemplate = data => {
  ...
  return `
    <div class="data-item">
      <div class="image">
        <img src="${data.show.image ? data.show.image.medium : ''}" alt="image">
      </div>
      ...
      <div><span>Description:</span>${data.show.sumary}</div>
    </div>
  `
}
